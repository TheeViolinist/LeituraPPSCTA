# Código responsável por alinhar na mesma sequencia o arquivo de resumo de orientadores com o criado com projetos
import json
...
def main():
    ...
    path_projetos = "../CriadorDados/projetos2014.json"
    ...
    counter = 0
    # Vamos percorrer cada linha dos projetose dps percorrer cada linha de resumos dos meus orientadores
    # Quando for achado o mesmo projeto no resumo, adicionamos uma nova linha de resumo id e adicionamos na lista
